...
// Nézd meg a connecting_ili9488_pico.png és a Connections.png képeket a bekötéshez
#ifdef PICO_ZERO
#define TFT_CS 4  // Chip select control pin - bármilyen pin lehet  - PICO Zero
#define TFT_RST 5 // Reset pin (could connect to Arduino RESET pin) - bármilyen pin lehet  - PICO Zero
#define TFT_DC 6  // Data Command control pin - bármilyen pin lehet  - PICO Zero
