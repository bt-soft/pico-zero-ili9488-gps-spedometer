...
class ScreenEmpty : public UIScreen, public ButtonsGroupManager<ScreenEmpty> {

  public:
    /**
     * @brief ScreenEmpty konstruktor
    ...
    virtual void drawContent() override {
        ...
        // Információs szöveg
        tft.setTextSize(1);
        tft.drawString("ScreenEmpty for debugging", ::SCREEN_W / 2, ::SCREEN_H / 2 + 20);
    }
